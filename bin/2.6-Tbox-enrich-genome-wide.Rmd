...
```{r save-gw-scan}
save(gw, file = "experiments/2019-02-05-tbx-presence/data/pwmEnrich-logn-genomoeWide.Rdata")
```
...
p.05 <- dn$sequence.bg[,2:5] < .05
p.01 <- dn$sequence.bg[,2:5] < .01
p.001 <- dn$sequence.bg[,2:5] < .001
p.0001 <- dn$sequence.bg[,2:5] < .0001
