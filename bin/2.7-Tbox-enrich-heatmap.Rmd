...
#load("experiments/2018-07-11-tbx-motifs/data/2019-02-04-Tbox-anc1-reg-enriched.Rdata",verbose = TRUE)
...
# Get the readable gene names and assign as the matrix rownames.
gnames <- mRNA.ids$external_gene_name[which(mRNA.ids$ensembl_gene_id %in% rownames(tbx.pv.dn.mat))]
...
tbx.bool.dn.mat <- (tbx.pv.dn.mat < .1)
