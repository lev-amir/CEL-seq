...
Extract the transcription factors that are differentially regulated by 
anc-1 RNAi. Only transcription factors with a known binding motif.
```{r}
TFs.a1 <- DEG$INTERSECT.reg[DEG$INTERSECT.reg %in% TFs$ensembl_gene_id]
TFs.a1 <- BOTH[BOTH$Gene_stable_ID %in% TFs.a1,]
```
